...
public class HotspotsAreaHolder extends TreeNode.BaseNodeViewHolder<HotspotArea> {
    private TextView tvName2;

    public HotspotsAreaHolder(Context context) {
        super(context);
    }
    ...
    public View createNodeView(TreeNode treeNode, HotspotArea hotspotArea) {
        ...
        final View view = inflater.inflate(R.layout.hotspots_area_item, null, false);
