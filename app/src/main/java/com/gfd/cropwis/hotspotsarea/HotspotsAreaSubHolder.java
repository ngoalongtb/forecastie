...
public class HotspotsAreaSubHolder extends TreeNode.BaseNodeViewHolder<HotspotArea> {
    private TextView tvHotspotValue;
    private TextView tvHotspotName3;

    public HotspotsAreaSubHolder(Context context) {
        super(context);
    }
    ...
    public View createNodeView(TreeNode treeNode, HotspotArea hotspotArea) {
        ...
        final View view = inflater.inflate(R.layout.hotspots_area_sub_item, null, false);
